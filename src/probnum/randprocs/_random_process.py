...
class RandomProcess(Generic[_InputType, _OutputType], abc.ABC):
    ...
    @abc.abstractmethod
    def __call__(self, args: _InputType) -> random_variables.RandomVariable[_OutputType]:
    ...
    def marginal(self, args: _InputType) -> _RandomVariableList:
    ...
    def push_forward(
        self,
        args: _InputType,
        base_measure: Type[random_variables.RandomVariable],
        sample: np.ndarray,
    ) -> np.ndarray:
