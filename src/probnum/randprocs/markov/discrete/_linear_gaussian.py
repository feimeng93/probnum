...
from probnum import config, linops, random_variables
...
class LinearGaussian(_nonlinear_gaussian.NonlinearGaussian):
    ...
    def _forward_rv_classic(
    ...
    ) -> Tuple[random_variables.RandomVariable, typing.Dict]:
        ...
        if compute_gain:
            ...
            info["gain"] = gain
        return random_variables.Normal(new_mean, cov=new_cov), info
    ...
    def _forward_rv_sqrt(
        ...
        return (
            random_variables.Normal(new_mean, cov=new_cov, cov_cholesky=new_cov_cholesky),
            info,
        )
    ...
    def _backward_rv_sqrt(
        ...
        return random_variables.Normal(new_mean, new_cov, cov_cholesky=new_cov_cholesky), info
    ...
    def _backward_rv_joseph(
        ...
        info = {"rv_forwarded": rv_forwarded}
        return random_variables.Normal(new_mean, new_cov), info
