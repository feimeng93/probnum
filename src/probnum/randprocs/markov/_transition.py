...
from probnum import random_variables, _randomvariablelist
...
class Transition(abc.ABC):
    ...
    def smooth_list(
        ...
        Parameters
        ----------
        rv_list : random_variables._RandomVariableList
        ...
        Returns
        -------
        random_variables._RandomVariableList
        ...
        out_rvs.reverse()
        return random_variables._RandomVariableList(out_rvs)
